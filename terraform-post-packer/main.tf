...
# The IDs of all ARM64 cisagov/windows-commando-vm-packer AMIs
...
#   filter {
#     name   = "name"
#     values = ["windows-commando-vm-*-arm64-ebs"]
#   }
#
#   filter {
...
# The IDs of all x86-64 cisagov/windows-commando-vm-packer AMIs
data "aws_ami_ids" "historical_amis_x86_64" {
  ...
  filter {
    name   = "name"
    values = ["windows-commando-vm-*-x86_64-ebs"]
  }

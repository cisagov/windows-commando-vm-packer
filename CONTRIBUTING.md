...
issue](https://github.com/cisagov/windows-commando-vm-packer/issues) in this
...
request](https://github.com/cisagov/windows-commando-vm-packer/pulls), you will
...
```console
cd windows-commando-vm-packer
pyenv virtualenv <python_version_to_use> windows-commando-vm-packer
pyenv local windows-commando-vm-packer
